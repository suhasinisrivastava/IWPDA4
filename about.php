...
<section class="about">
    ...
    <div class="flex">
        ...
        <div class="content">
        <h3>why us?</h3>
            <p>because we believe If you look the right way, you can see that the whole world is a garden.</p>
    ...
    <div class="flex">
        ...
        <div class="content">
        <h3>What we do?</h3>
            <p>provide you with beautiful, fragrant flowers</p>
...
<div style="background-color: rgb(247, 249, 250); 
    box-shadow: 0 4px 8px 0 rgba(209, 103, 238, 0.2), 0 6px 6px 0 rgba(7, 7, 7, 0.2); padding-top: 10px; padding-bottom: 5px;"><h1 class="title">client's reviews</h1></div>
    <br>
    <br>
